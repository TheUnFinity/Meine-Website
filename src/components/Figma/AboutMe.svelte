...
<style>
  ...
  .about-me-all {
    ...
    flex-direction: row;
    align-items: center;
    background: linear-gradient(105deg, rgb(75, 75, 75) 0%, rgb(8, 8, 8) 100%);
    margin-bottom: 128px;
    width: 100%;
  }
